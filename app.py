...
class Locations(Resource):
    ...
    def patch(self):
        ...
        if args['locationId'] in list(data['locationId']):
            # if it exists, we can updateit, first we get the user row
            ...
            return {
                'message': f" '{args['locationId']}' location doesn't exists."
            }, 404
    ...
    def delete(self):
        ...
        if args['locationId'] in list(data['locationId']):
            ...
            return {
                'message': f" '{args['locationId']}' location doesn't exist. "
            }

api.add_resource(Users, '/users')  # '/users' is our endpoints for Users
api.add_resource(Locations, '/locations')  # and '/locations' is our endpoints for Locations
